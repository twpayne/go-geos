...
func TestGetPoints(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			name:   TypeIDPoint.String(),
			wkt:    "POINT (0.0000000000000000 0.0000000000000000)",
			points: &[][]float64{{0, 0}},
		},
		{
			name:   TypeIDMultiPoint.String(),
			wkt:    "MULTIPOINT ((0.0000000000000000 1.0000000000000000), (2.0000000000000000 3.0000000000000000), (4.0000000000000000 5.0000000000000000))",
			points: &[][]float64{{0, 1}, {2, 3}, {4, 5}},
		},
		{
			name:   TypeIDLineString.String(),
			wkt:    "LINESTRING (0.0000000000000000 0.0000000000000000, 1.0000000000000000 0.0000000000000000)",
			points: &[][]float64{{0, 0}, {1, 0}},
		},
		{
			name:   TypeIDMultiLineString.String(),
			wkt:    "MULTILINESTRING ((0.0000000000000000 0.0000000000000000, 1.0000000000000000 0.0000000000000000, 1.0000000000000000 1.0000000000000000, 0.0000000000000000 1.0000000000000000, 0.0000000000000000 0.0000000000000000)))",
			points: &[][]float64{{0, 0}, {1, 0}, {1, 1}, {0, 1}, {0, 0}},
		},
		{
			name:   TypeIDPolygon.String(),
			wkt:    "POLYGON ((0.0000000000000000 0.0000000000000000, 1.0000000000000000 0.0000000000000000, 1.0000000000000000 1.0000000000000000, 0.0000000000000000 1.0000000000000000, 0.0000000000000000 0.0000000000000000)))",
			points: &[][]float64{{0, 0}, {1, 0}, {1, 1}, {0, 1}, {0, 0}},
		},
		{
			name:   TypeIDMultiPolygon.String(),
			wkt:    "MULTIPOLYGON (((-1 -1, 0 -1, 0 0, -1 -1)), ((0.0000000000000000 0.0000000000000000, 3.0000000000000000 0.0000000000000000, 3.0000000000000000 3.0000000000000000, 0.0000000000000000 3.0000000000000000, 0.0000000000000000 0.0000000000000000), (1.0000000000000000 1.0000000000000000, 1.0000000000000000 2.0000000000000000, 2.0000000000000000 2.0000000000000000, 2.0000000000000000 1.0000000000000000, 1.0000000000000000 1.0000000000000000)))",
			points: &[][]float64{{-1, -1}, {0, -1}, {0, 0}, {-1, -1}, {0, 0}, {3, 0}, {3, 3}, {0, 3}, {0, 0}},
		},
		{
			name:   TypeIDLinearRing.String(),
			wkt:    "LINEARRING (0.0000000000000000 0.0000000000000000, 1.0000000000000000 0.0000000000000000, 1.0000000000000000 1.0000000000000000, 0.0000000000000000 0.0000000000000000)",
			points: &[][]float64{{0, 0}, {1, 0}, {1, 1}, {0, 0}},
		},
		{
			name:   TypeIDGeometryCollection.String(),
			wkt:    "GEOMETRYCOLLECTION (POINT (0.0000000000000000 1.0000000000000000), LINESTRING (2.0000000000000000 3.0000000000000000, 4.0000000000000000 5.0000000000000000), MULTIPOINT (6.0000000000000000 7.0000000000000000))",
